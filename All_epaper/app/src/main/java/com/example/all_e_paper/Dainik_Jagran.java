...
public class Dainik_Jagran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dainik__jagran);
        this.setTitle("Dainik Jagran");
...
//                Log.i(TAG, loadAdError.getMessage());
        ...
        live.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gotoUrl("https://www.jagran.com/");
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(Dainik_Jagran.this);
                } else {
        ...
        divyabhaskar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://epaper.jagran.com/epaper/");
                if (mInterstitialAd != null) {
                    mInterstitialAd.show(Dainik_Jagran.this);
                } else {
                    //Log.d("TAG", "The interstitial ad wasn't ready yet.");
